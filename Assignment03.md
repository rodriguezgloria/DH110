...
Facilitating the experience, I found out that I need to better clarify the activity because the participant was briefly confused but after more clarification they understood. The script was a great outline to conduct the contextual inquiry effectively since it felt like there was an even exchange of dialogue between the participant and I. The real challenge though was trying to write observation notes at the same time I was facilitating the contextual inquiry. Therefore multitasking was very difficult. In order to address this, maybe it would be best to minimize the amount of questions I have asked. 

Overall, conducting the contextual inquiry was very eye-opening because I was able to empathize with the user better in order to address their needs through design. 
